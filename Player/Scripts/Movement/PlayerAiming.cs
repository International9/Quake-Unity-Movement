...
public class PlayerAiming : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Dynamic FOV:
        if (!cam || !enableDynamicFieldOfView || !gameMovement.Instance) return;

        cam.fieldOfView = defaultFOV + Vector3.Dot(gameMovement.Instance.data.velocityXZ, transform.forward) * fovMultiplier;
